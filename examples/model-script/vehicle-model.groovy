...
modelScript('''
{
  ...
  "operations": [
    ...
    {"op":"element","external_id":"POWER_IF","kind":"InterfaceBlock","name":"PowerInterface","owner":"handle:PKG"},
    {"op":"element","external_id":"CTRL_POWER","kind":"ProxyPort","name":"power","owner":"handle:CTRL","type_ref":"handle:POWER_IF"},
    {"op":"element","external_id":"BAT_POWER","kind":"ProxyPort","name":"power","owner":"handle:BAT","type_ref":"handle:POWER_IF"},
    ...
    {"op":"connector","external_id":"CTRL_LINK","context":"handle:VEH","kind":"Assembly","source_path":["CONTROLLER","CTRL_POWER"],"target_path":["BATTERY","BAT_POWER"],"name":"controlPower"},
    {"op":"item_flow","external_id":"STARTED_FLOW","connector":"handle:CTRL_LINK","source_path":["CONTROLLER","CTRL_POWER"],"target_path":["BATTERY","BAT_POWER"],"conveyed_items":["handle:SIG_STARTED"],"name":"startedFlow"},
