...
mod tests {
    ...
    fn delete_association_used_as_connector_type_preserves_model_views_and_redo() {
        ...
        super::super::history::checkpoint_states(&fixture.state, &fixture.activity, history)
            .unwrap();
        fixture.state.project.lock().unwrap().as_mut().unwrap().name = "Pending redo".into();
        assert!(
            super::super::history::undo_states(&fixture.state, &fixture.activity, history).unwrap()
        );
        let before = snapshot(&fixture.state);
        let error = delete_bdd_relationship_in_state(
        ...
        assert!(
            super::super::history::redo_states(&fixture.state, &fixture.activity, history).unwrap()
        );
    }
