...
fn behavior_semantic_id(
    repository: &systems_modeler_core::BehaviorRepository,
    namespace: &str,
    external: &str,
...
fn create_script_diagram(
    ...
    match family {
        ...
        "activity" => {
            ...
            let key = external_key(namespace, semantic.strip_prefix("ext:").unwrap_or(semantic));
