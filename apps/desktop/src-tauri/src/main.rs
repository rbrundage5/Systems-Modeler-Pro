...
use workspace::{
    ...
    clear_workspace_interaction, copy_selection,
    ...
    new_project, open_project_file, open_project_file_complete, paste_selection, place_bdd_element,
    place_element_on_bdd, place_on_package_diagram, place_on_parametric_diagram,
    pause_activity_execution, place_on_requirement_diagram, place_on_use_case_diagram,
    ...
    route_activity_diagram, route_behavior_diagram, run_activity_execution,
    ...
    update_activity_presentation_geometry, update_actor_details,
