mod workspace {
    ...
    pub use activity_execution::{
        ...
        initialize_activity_execution, pause_activity_execution,
        preview_activity_execution_runtime, reset_activity_execution, resume_activity_execution,
        run_activity_execution, step_activity_execution, terminate_activity_execution,
    };
    ...
    pub use sequence_execution::{
        SequenceExecutionState, clear_sequence_executions,
        configure_sequence_execution_runtime, initialize_sequence_execution,
        pause_sequence_execution, preview_sequence_execution_runtime, reset_sequence_execution,
        resume_sequence_execution, run_sequence_execution, sequence_execution_runtime_selection,
        sequence_execution_snapshot, step_sequence_execution, terminate_sequence_execution,
    };
    pub use use_cases::{
...
use serde::Serialize;
use workspace::{
    ActivityExecutionState, ActivityWorkspaceState, HistoryState, SharedWorkspaceState,
    SequenceExecutionState, StandardEditingState, StateMachineExecutionState, WorkspaceState,
    activate_diagram,
    ...
    add_activity_action, add_activity_edge, add_activity_node, add_activity_parameter_node,
    add_activity_partition, add_combined_fragment, add_combined_fragment_operand,
    add_composite_state, add_execution_specification, add_item_flow_to_connector,
    add_nested_port_to_ibd, add_sequence_lifeline, add_sequence_message, add_state_invariant,
    add_state_region, add_state_transition, add_state_transition_complete, add_state_vertex,
    ...
    pause_state_machine_execution, pause_sequence_execution, place_bdd_element,
    ...
    route_activity_diagram, route_behavior_diagram, route_diagram_geometry, route_ibd,
    run_activity_execution, run_sequence_execution, run_state_machine_execution,
    save_activity_workspace,
    ...
    set_diagram_frame_preference, set_panel_preferences, set_viewport_preference,
    sequence_execution_runtime_selection, sequence_execution_snapshot, set_workspace_interaction,
...
fn main() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            sequence_execution_snapshot,
            sequence_execution_runtime_selection,
            preview_sequence_execution_runtime,
