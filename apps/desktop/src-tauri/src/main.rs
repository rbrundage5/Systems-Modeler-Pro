...
use workspace::{
    ...
    clear_workspace_interaction, create_activity_diagram, create_bdd, create_bdd_element,
    ...
    create_state_machine_diagram_staged, delete_activity_item, delete_bdd_relationship,
    delete_behavior_item, diagram_command_manifest, diagram_family_registry, fit_diagram_viewport,
