mod workspace {
    ...
    pub use shared_workspace::{
        ...
        get_panel_preferences, get_viewport_preference, set_diagram_frame_preference,
        set_panel_preferences, set_viewport_preference, set_workspace_interaction,
        workspace_interaction_snapshot, zoom_diagram_viewport,
    };
}
...
use workspace::{
    ...
    save_project_file, save_project_file_complete, semantic_presentation_manifest,
    semantic_presentation_stylesheet, set_diagram_frame_preference, set_panel_preferences,
    set_viewport_preference, set_workspace_interaction, update_activity_node_semantics,
